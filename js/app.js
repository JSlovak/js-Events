...
function lessContent(){
	var lessHip = document.getElementById ("less");
	lessHip.innerHTML = "";
}
...
function zoom(){
	var makeBigger = document.getElementById("biggie");
	makeBigger.style.fontSize = "150%";
...
var menu = ["French Fries ", "McFlurry ", "Chicken Nuggets"];

function valueMenu (){
	var publishMenu = document.getElementById("menu");
	publishMenu.innerHTML = menu;
...
var speak = document.getElementById ("Benjamin");
speak.addEventListener("click", displayQuote);

function displayQuote (){
	var saySumptin = document.getElementById ("displayQuote");
	saySumptin.innerHTML = myQuote;
...
random.createEventListener("click", speakRandom);

		function speakRandom() { 
		var randomQuote = Math.floor(Math.random() * quotes.length);
		displayQuote.innerHTML = quotes[randomQuote];
		}

//displayQuote.innerHTML = randomQuote; NEED HELP!!!
...
showHide.createEventListener ("click", showOrHideMessage);

function showOrHideMessage(){

var message = document.getElementById ("freedom");

		if (message.style.display === "") {
 		message.style.display = "freedom";
 		}
 			else { showmoney.style.display = "";
		}
